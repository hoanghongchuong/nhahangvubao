                    ...
                    <aside class="menu-aside">
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="td-wrap">
                                ...
                                <div id="collapse{{$k}}" class="collapse @if($k==0)show @endif" data-parent="#accordionExample">
                                  <div class="menu-body">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <article class="menu-item text-center">
                                <figure class="menu-img">
                                    <a href="{{ url('menu/'.$item->alias) }}" title="{{$item->name}}"><img src="{{asset('upload/product/'.$item->photo)}}" title="{{$item->name}}" alt="{{$item->name}}"></a>
                                </figure>
                                <h2 class="t1 s18 text-uppercase sbold menu-info">
                                    <a href="{{ url('menu/'.$item->alias) }}" title="{{$item->name}}">{{$item->name}}</a>
                                </h2>
                            </article>
                        </div>
                        @endforeach
