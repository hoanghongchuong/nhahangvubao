            ...
            <div class="row">
                <div class="col-lg-8 col-md-7">
                    ...
                    <div class="bdetail-re">
                        ...
                        @foreach($postDifferent as $b)
                        <article class="bdetailre-item">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="bdetailre-img text-center"><a href="{{ url('khuyen-mai/'.$b->alias.'.html') }}" title=""><img src="{{asset('upload/news/'.$b->photo)}}" title="" alt=""></a></div>
                                </div>
                                <div class="col-lg-8">
                                    <h3 class="bold s18 bdetail-retit"><a href="{{ url('khuyen-mai/'.$b->alias.'.html') }}" title="">{{$b->name}}</a></h3>
