<aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="treeview ">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Quản lý thực đơn</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
        ...
        <li class="treeview ">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="backend/news?type=tin-tuc"><i class="fa fa-circle-o"></i> <span>Danh sách</span></a></li>    
          </ul>
        </li>
        <li class="treeview ">
            <a href="#">
                <i class="fa fa-dashboard"></i> <span>Không gian</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
                <li><a href="backend/about/edit?type=khong-gian"><i class="fa fa-circle-o"></i> <span>Mô tả</span></a></li>
                <li><a href="backend/slider?type=khong-gian"><i class="fa fa-circle-o"></i> <span>Hình ảnh</span></a></li>    
            </ul>
        </li>
