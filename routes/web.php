...
Route::get('menu',['as'=>'getProduct', 'uses'=>'IndexController@getProduct']);
// Route::get('menu/{alias}.html','IndexController@getProductDetail')->name('detailProduct');
Route::get('menu/{id}',['as'=>'getProductList', 'uses'=>'IndexController@getProductList']);
...
Route::get('tuyen-dung/{alias}.html',['as'=>'getTuyenDungDetail', 'uses'=>'IndexController@getNewsTuyenDungDetail']);

Route::get('khuyen-mai','IndexController@getKhyenMai')->name('getKhyenMai');
Route::get('khuyen-mai/{alias}.html',['as'=>'getKhyenMaiDetail', 'uses'=>'IndexController@getKhyenMaiDetail']);
